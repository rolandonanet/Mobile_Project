...
public class ClassStudentViewHolder extends RecyclerView.ViewHolder {
    public TextView student_class_subjectTV;
    public TextView student_class_dayTV;
    public TextView student_class_studentAmmountTV;
    public TextView student_class_themeTV;
